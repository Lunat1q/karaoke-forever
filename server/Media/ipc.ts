...
import { MEDIA_ADD, MEDIA_CLEANUP, MEDIA_REMOVE, MEDIA_UPDATE, YOUTUBE_VIDEO_UPDATE } from '../../shared/actionTypes.js'
...
export default function (io) { // eslint-disable-line @typescript-eslint/no-unused-vars
  return {
    ...
    [YOUTUBE_VIDEO_UPDATE]: ({ payload }) => Media.updateYoutubeVideo(payload, io),
  }
}
