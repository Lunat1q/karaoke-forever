...
export const YOUTUBE_CMD_START = 'youtubeWorker/CMD_START'
export const YOUTUBE_CMD_STOP = 'youtubeWorker/CMD_STOP'
export const YOUTUBE_CMD_UPDATE = 'youtubeWorker/CMD_UPDATE'
export const YOUTUBE_WORKER_STATUS = 'youtubeWorker/STATUS'
export const YOUTUBE_VIDEO_UPDATE = 'youtubeWorker/VIDEO_UPDATE'
